...
If $level is undefined or omitted, this function returns a list
...
sub allow
{
	...
	my $data = {};
	my $authid = 'urn:uuid:'.$self->_uuid_generator->create_str;
...
If $filename is provided, this function writes to the file
and returns the new file size in bytes.

If $filename is omitted, this function does not attempt to write
